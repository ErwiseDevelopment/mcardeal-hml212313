...
if ( $cats_list && in_array( 'cats', $porto_settings['post-metas'] ) ) {
	$post_meta .= '<span class="meta-cats m-l-lg">' . esc_html__( 'Categoria: ', 'porto' ) . $cats_list . '</span>';
}
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $post_class ); ?>>
	...
	<?php endif; ?>
			...
			<div>
				<a class="btn btn-lg btn-borders btn-primary custom-border-radius font-weight-semibold text-uppercase m-t-lg" href="<?php echo esc_url( apply_filters( 'the_permalink', get_permalink() ) ); ?>"><?php esc_html_e( 'Ler mais', 'porto' ); ?></a>
			</div>
